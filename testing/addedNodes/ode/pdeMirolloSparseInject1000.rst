...
DGL of pdeMirolloSparseInject1000
------------------------------------------
...
::
	...
	double xminus1 = xlast * (1 + m() * leftOut) / ( 1 - m() * rightOut);

	dxdt[0]= -(3*x[0] -4* xminus1 + x[N-1]) * N + rate * ( rightOut) + rate * leftOut - rate *  x[0];

	dxdt[1]= -(3*x[1] -4* x[0] + xminus1) * N  - rate *  x[1];
...
Parameter of pdeMirolloSparseInject1000
-----------------------------------------



- pdeMirolloSparseInject1000_m 		 =  0.2000000000000000; 
- pdeMirolloSparseInject1000_a 		 =  0.0100000000000000; 
- pdeMirolloSparseInject1000_b 		 =  0.0500000000000000; 
